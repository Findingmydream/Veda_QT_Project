...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)()>(_a, &NetworkManager::peerConnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)()>(_a, &NetworkManager::peerDisconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)(QJsonObject )>(_a, &NetworkManager::messageReceived, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)(QString )>(_a, &NetworkManager::networkError, 3))
            return;
    }
}
...
// SIGNAL 1
void NetworkManager::peerDisconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void NetworkManager::messageReceived(QJsonObject _t1)
{
