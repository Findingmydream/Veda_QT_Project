...
namespace {
struct qt_meta_tag_ZN18PlayerSearchDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto PlayerSearchDialog::qt_create_metaobjectdata<qt_meta_tag_ZN18PlayerSearchDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PlayerSearchDialog, qt_meta_tag_ZN18PlayerSearchDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PlayerSearchDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18PlayerSearchDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18PlayerSearchDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18PlayerSearchDialogE_t>.metaTypes,
    nullptr
} };
...
void *PlayerSearchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18PlayerSearchDialogE_t>.strings))
